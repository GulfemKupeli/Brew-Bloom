<p align="center">
  <img src="frontend/src/assets/logo.png" alt="Brew & Bloom Logo" width="200"/>
</p>
...
## 🖼 Assets
Placeholder images live in `frontend/src/assets/`. Replace these PNG files with your own artwork to customize the look:
`logo.png`, `coin.png`, `seed.png`, `sprout.png`, `herb.png`, `wateringcan.png`, `sun.png`, `moon.png`, `timer_page_background.png`.
