  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      {Object.keys(inventory).length === 0 ? (
        <div className="bg-white/80 rounded-lg p-12 text-center border-4 border-green-700">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {Object.entries(inventory).map(([seedId, count]) => {
            ...
            return (
              <div
                key={seedId}
                className="bg-gradient-to-br from-white to-green-50 rounded-xl border-4 border-green-700 p-6 text-center"
              >
      ...
      <div className="mt-8 bg-amber-100 border-4 border-amber-500 rounded-lg p-6 text-center">
